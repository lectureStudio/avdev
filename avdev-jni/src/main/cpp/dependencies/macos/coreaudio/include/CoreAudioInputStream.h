...
#ifndef AVDEV_COREAUDIO_INPUT_STREAM_H_
#define AVDEV_COREAUDIO_INPUT_STREAM_H_
...
namespace avdev
{
	class CoreAudioInputStream : public CoreAudioStream, public AudioInputStream
	{
		public:
			CoreAudioInputStream(AudioDeviceID devID, PAudioSource source);
			virtual ~CoreAudioInputStream() {};
