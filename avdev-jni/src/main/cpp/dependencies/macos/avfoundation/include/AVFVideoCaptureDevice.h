...
#ifndef AVDEV_AVF_VIDEO_CAPTURE_DEVICE_H_
#define AVDEV_AVF_VIDEO_CAPTURE_DEVICE_H_

#include "VideoCaptureDevice.h"

namespace avdev
{
	class AVFVideoCaptureDevice : public VideoCaptureDevice
	{
		public:
			AVFVideoCaptureDevice(std::string name, std::string descriptor);
